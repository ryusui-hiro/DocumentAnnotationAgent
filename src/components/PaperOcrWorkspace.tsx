...
import { ArrowLeft, BookOpen, Check, ChevronDown, ChevronLeft, ChevronRight, Copy, Download, ExternalLink, Eye, FileText, Globe2, Github, Layers3, LoaderCircle, Maximize2, MessageSquareText, MousePointer2, ScanLine, Settings2, Sparkles, Square, StopCircle, Trash2, Upload, X, ZoomIn, ZoomOut } from 'lucide-react';
